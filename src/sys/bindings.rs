...
extern "C" {
    #[link_name = "\u{1}_Z17CTP_GetSystemInfoPcRi"]
    pub fn CTP_GetSystemInfo(
        pSystemInfo: *mut ::std::os::raw::c_char,
        nLen: *mut ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_Z28CTP_GetDataCollectApiVersionv"]
    pub fn CTP_GetDataCollectApiVersion() -> *const ::std::os::raw::c_char;
}
